...
def _load_clarification_templates() -> Dict[str, str]:
    ...
    # clarification_router.py is at: src/core/rendering/clarification_router.py
    # config file is at: src/core/rendering/clarification_templates.yaml
    current_file = Path(__file__)
    config_file = current_file.parent / "clarification_templates.yaml"
