"""
Legacy wrapper: multi-turn appointment confirmation with real Luma + mock booking.

Prefer: RUN_REAL_LUMA_E2E=true python core/tests/test.py --category smoke
Targeted: RUN_REAL_LUMA_E2E=true pytest core/tests/e2e/test_core_e2e_followup_confirm_appointment_real_luma.py
"""
...
_SCENARIOS = load_e2e_scenarios(
    _SCENARIOS_DIR, "followup_confirm_appointment_real_luma.yaml"
)
...
def test_followup_confirm_appointment_real_luma(scenario: Dict[str, Any]):
    run_legacy_e2e_scenario(
        scenario,
        user_id_prefix="test_confirm_appointment",
