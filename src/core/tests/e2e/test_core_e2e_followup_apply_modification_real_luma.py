"""
Legacy wrapper: booking modification with real Luma + mock booking.
...
_SCENARIOS = load_e2e_scenarios(
    _SCENARIOS_DIR, "followup_apply_modification_real_luma.yaml"
)
...
def test_followup_apply_modification_real_luma(scenario: Dict[str, Any]):
    run_legacy_e2e_scenario(
        scenario,
        user_id_prefix="test_apply_modification",
