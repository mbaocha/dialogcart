"""
Legacy wrapper: availability follow-up with real Luma + mock availability.
...
_SCENARIOS = load_e2e_scenarios(
    _SCENARIOS_DIR, "followup_availability_real_luma.yaml"
)
...
def test_followup_availability_real_luma(scenario: Dict[str, Any]):
    run_legacy_e2e_scenario(
        scenario,
        user_id_prefix="test_followup_availability",
        assert_execution_calls=False,
    )
