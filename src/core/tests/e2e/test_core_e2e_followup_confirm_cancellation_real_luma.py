"""
Legacy wrapper: cancellation confirmation with real Luma + mock booking.
...
_SCENARIOS = load_e2e_scenarios(
    _SCENARIOS_DIR, "followup_confirm_cancellation_real_luma.yaml"
)
...
def test_followup_confirm_cancellation_real_luma(scenario: Dict[str, Any]):
    run_legacy_e2e_scenario(
        scenario,
        user_id_prefix="test_confirm_cancellation",
