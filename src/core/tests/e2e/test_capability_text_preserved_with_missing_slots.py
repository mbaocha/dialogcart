...
def test_capability_text_preserved_when_missing_slots_present():
    ...
    try:
        ...
        has_payment_keywords = (
            ...
            "link" in text_lower or
            "complete" in text_lower or
            "booking" in text_lower
        )
        assert has_payment_keywords, \
