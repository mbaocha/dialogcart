...
- **test_orchestrator_e2e.py**: End-to-end tests (requires NLU and business APIs running)
...
- E2E and interactive tests require:
  - NLU API running (default: http://localhost:9002; set LUMA_BASE_URL to override)
