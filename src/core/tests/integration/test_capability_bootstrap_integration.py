...
from capabilities.registry import get_adapter, clear_registry
from capabilities.runner import CapabilityRunner
from core.orchestration.api.message import post_message, MessageRequest
    ...
    with patch("core.orchestration.api.message.handle_message") as mock_handle:
        ...
        try:
            ...
            try:
                ...
                assert adapter is not None, "Payment adapter should be registered after bootstrap"
