...
core_booking_scenarios = [
    ...
    # ────────────────
    {
        ...
        "expected": {
            ...
            "slots": {
                "service_id": "standard",
                "date_range": {"start": "2026-10-12", "end": "2026-10-14"},
            },
        },
    },
    {
        ...
        "expected": {
            ...
            "slots": {
                "service_id": "delux",
                "date_range": {"start": "2026-11-01", "end": "2026-11-03"},
            },
        },
    },
    {
        ...
        "expected": {
            ...
            "slots": {
                "service_id": "room",
                "date_range": {"start": "2026-12-20", "end": "2026-12-25"},
            },
        },
    },
    {
        ...
        "expected": {
            ...
            "slots": {
                "service_id": "suite",
                "date_range": {"start": "2026-02-01", "end": "2026-02-05"},
            },
        },
    },
    # ────────────────
    ...
    },
    {
        ...
        "expected": {
            "intent": "CREATE_APPOINTMENT",
            "status": STATUS_EXECUTED,  # Or AWAITING_CONFIRMATION
            "slots": {"service_id": "premium haircut", "has_datetime": True},
        },
    },
    {
        ...
        "expected": {
            "intent": "CREATE_APPOINTMENT",
            "status": STATUS_EXECUTED,  # Or AWAITING_CONFIRMATION
            "slots": {"service_id": "beard", "has_datetime": True},
        },
    },
    # ────────────────
