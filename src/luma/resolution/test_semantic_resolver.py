...
spec_resolver = importlib.util.spec_from_file_location(
    "luma.resolution.semantic_resolver", resolver_path
)
...
def test_exact_time():
    ...
    intent_result = {
        ...
        "structure": {"time_type": "exact", "needs_clarification": False},
    }
...
def test_time_window():
    ...
    intent_result = {
        ...
        "structure": {"time_type": "window", "needs_clarification": False},
    }
...
def test_time_range():
    ...
    intent_result = {
        ...
        "structure": {"time_type": "range", "needs_clarification": False},
    }
...
def test_date_range():
    ...
    intent_result = {
        ...
        "structure": {"time_type": "none", "needs_clarification": False},
    }
...
def test_simple_relative_days():
    ...
    for date_text, expected_mode in test_cases:
        ...
        ), f"Should not need clarification for '{date_text}'"
...
def test_fine_grained_modifiers():
    ...
    for date_text in test_cases:
        ...
        result = resolve_semantics(intent_result, entities)
        assert (
            result.resolved_booking["date_mode"] == "range"
        ), f"'{date_text}' should resolve to range, not single_day"
