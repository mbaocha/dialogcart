...
class LumaConfig:
    ...
    ENABLE_INTENT_MAPPER: bool = os.getenv("ENABLE_INTENT_MAPPER", "true").lower() == "true"
    ...
    ENTITY_CATALOG_PATH: str = os.getenv("ENTITY_CATALOG_PATH", "luma/store/merged_v9.json")
