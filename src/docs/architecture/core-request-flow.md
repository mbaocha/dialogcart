...
│  core/planning/orchestration/turn_planner.py        │
...
└── core/
    ...
    ├── routing/              Intent → workflow mapping
...
**File:** `core/planning/orchestration/turn_planner.py`  
**Function:** `plan_turn(...)`  
...
**File:** `core/planning/orchestration/intent_resolution.py`  
...
**File:** `core/planning/orchestration/plan_builder.py`  
...
### 5. `core/planning/orchestration/plan_builder.py`
